    ...
    <div className="min-h-screen w-full bg-[color:var(--brand-primary-muted)] text-[color:var(--brand-text)]" style={styleVars}>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0" aria-hidden>
          <div className="h-64 w-64 md:h-[28rem] md:w-[28rem] rounded-full blur-3xl opacity-20" style={{ background: "var(--brand-accent)" }} />
        </div>
        <div className="max-w-6xl mx-auto px-4 pt-14 pb-16 md:pt-24 md:pb-24 grid md:grid-cols-2 gap-10 items-center">
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="mt-5 text-base md:text-lg text-[color:var(--brand-text-muted)] max-w-prose">
              Archivedesign.ai connects homeowners, architects, and builders on a marketplace for beautiful, code-aware plans. Save months, control costs, and share value with the original designer.
            </p>
            <div className="mt-7 flex flex-col sm:flex-row gap-3">
              <a href="#signup" className="inline-flex justify-center items-center rounded-2xl px-5 py-3 font-medium shadow hover:shadow-md transition-all" style={{ background: "var(--brand-accent)", color: "white"}}>Get early access</a>
              <a href="#how" className="inline-flex justify-center items-center rounded-2xl px-5 py-3 font-medium border border-black/10 hover:bg-black/5 transition-all">See how it works</a>
            </div>
