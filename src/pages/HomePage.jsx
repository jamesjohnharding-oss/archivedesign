  ...
  "@graph": [
    {
      ...
      "logo": "https://archivedesign.com.au/logo.png",
    },
    {
      "@type": "WebSite",
      "name": "Archive Design",
...
export default function HomePage() {
  useEffect(() => {
    ...
    return () => {
      const s = document.getElementById("json-ld-home");
      if (s) s.remove();
    };
  }, []);
  ...
  return (
    <>
        ...
        <div className="hero-inner">
          <div className="hero-left">
            ...
            <p className="hero-sub">
              We match you with architects whose work already fits your vision
              and budget so you can design with confidence from day one.
            </p>
          ...
          <div className="hero-right">
            ...
            <div className="img-card">
              <div className="img-card-inner">
                ...
                <span className="img-tag" style={{ color: "#9E5E00", background: "rgba(253,243,227,0.92)" }}>
                  Kitchen
                </span>
              </div>
            </div>
            <div className="img-card">
              <div className="img-card-inner">
                ...
                <span className="img-tag" style={{ color: "#1A5C6B", background: "rgba(235,244,246,0.92)" }}>
                  Living
                </span>
              </div>
            </div>
        ...
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-sub">
              You don't need to trawl portfolios.
              <br />
              You need someone who understands what you're building — and why.
            </p>
          </div>
          <div className="steps">
            <div className="step">
              ...
              <p className="step-body">
                Tell us about your site, budget, lifestyle and what you're drawn
                to.
              </p>
            </div>
            <div className="step">
              ...
              <p className="step-body">
                From our archive of built and unbuilt homes, we identify projects
            ...
            <div className="step">
              ...
              <p className="step-body">
                We introduce you to a shortlist of matched architects. Start your
                project with shared references and realistic budget parameters
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="value-col">
              ...
              <ul className="value-list">
                <li className="value-item">
                  ...
                  <p className="value-item-body">
                    You may only commission an architect once. Starting with the
                    right partner changes everything and leads to better
                    architecture.
                  </p>
                </li>
                <li className="value-item">
                  ...
                  <p className="value-item-body">
                    Too many projects unravel after early drawings when budgets
                    don't align, expectations differ, or communication styles
                    clash. We reduce that risk before you commit.
                  </p>
                </li>
                <li className="value-item">
                  <div className="value-item-header">
                  ...
                  <p className="value-item-body">
                    See real examples of what similar budgets have delivered and
                    meet architects whose work already fits your brief.
                  </p>
                </li>
              </ul>
            ...
            <div className="value-col">
              ...
              <ul className="value-list">
                <li className="value-item">
                  ...
                  <p className="value-item-body">
                    Connect with educated homeowners who approached you because
                ...
                <li className="value-item">
                  ...
                  <p className="value-item-body">
                    Reduce the noise of speculative leads and focus on clients
                ...
                <li className="value-item">
                  ...
                  <p className="value-item-body">
                    Leverage your IP. Your portfolio (built and unbuilt) becomes
                    a passive engine for generating new commissions.
                  </p>
                </li>
              </ul>
              <Link to="/for-architects" className="text-link">
                Partner with us
              </Link>
            </div>
          </div>
      ...
      <section className="architect-band">
        <div className="architect-band-inner">
          ...
          <p className="band-sub">
            Join a curated network of Australia's best residential architects. We
            filter for serious homeowners who value design quality, not just the
            lowest fee.
          </p>
          <div className="band-actions">
            <Link to="/for-architects#apply" className="btn-band-primary">
              Apply as an Architect
            </Link>
            <a href="/for-architects#criteria" className="btn-band-secondary">
              View Criteria
            </a>
          </div>
        </div>
      ...
      <section className="waitlist" id="apply">
        <div className="waitlist-inner">
          ...
          <div className="waitlist-content">
            ...
            <p className="waitlist-sub">
              Archive Design is launching soon across Australia. Join the
              waitlist and we'll introduce you to the right architect the moment
              we open.
            </p>
          </div>
          <EarlyAccessSignup />
